...
以下介紹利用 Restfule Service 提供圖片資源，過程中讓我們可以修改圖片的內容，例如: 加上檔案名稱。
...
第一種情況:圖若片是放在一般目錄下。此時，提供 Web Service 的 end-point，將圖形放在 Response 的 Payload 中。回傳給客戶端，例如以下的 Restful end-point: `http://localhost:8080/unit13/rest/img/direct/test.png`

Get Request Handler 的處理程序:
1. 取得圖形檔案的串流
...
public static BufferedImage read(File input)
                          throws IOException
```
Ref: https://docs.oracle.com/javase/7/docs/api/javax/imageio/ImageIO.html#read(java.io.File)
